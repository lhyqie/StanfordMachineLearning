...
for  i = 1 : m
	...
	for k = 1 : num_labels,
		...
		J = J  -  yVec(k) * log( HX(i,k) ) -  ( 1- yVec(k)) * log( 1 - HX(i,k) );
...
for t = 1:m
	...
	% get  BigDelta_2 based on delta_3 and a_2
	Theta2_grad = Theta2_grad + delta_3 * a_2';
	% get  BigDelta_1 based on delta_2 and a_1
